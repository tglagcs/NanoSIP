...
void CListCtrl_Sortable::PreSubclassWindow()
{
	...
	EnableWindowTheme(GetSafeHwnd(), L"DarkMode_Explorer", NULL);
	SetWindowTheme(GetSafeHwnd(), L"DarkMode_ItemsView", NULL);
	if (GetHeaderCtrl()) {
		SetWindowTheme(GetHeaderCtrl()->GetSafeHwnd(), L"DarkMode_ItemsView", NULL);
	}
	SetTextColor(Theme::Text);
	SetTextBkColor(Theme::Window);
	SetBkColor(Theme::Window);
}
