...
LONG WINAPI ExceptionFilter(EXCEPTION_POINTERS *ExceptionInfo)
{
    ...
    if (!restart) {
#ifdef _GLOBAL_VIDEO
        message.Format(_T("A crash happened. Check your video card driver or try to install the LITE version (without video)."));
#else
        message.Format(_T("A crash happened. Make sure your system is working properly and that you have enough free memory and hard disk space. Check your sound device driver, antivirus software. Try disabling additional softphone features. You can try uninstalling MicroSIP \"with configuration\" and reinstalling it."));
#endif
