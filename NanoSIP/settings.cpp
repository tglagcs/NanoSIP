...
void AccountSettings::Init()
{
    ...
    ptr = str.GetBuffer(255);
    GetPrivateProfileString(section, _T("forceCodec"), _T("1"), ptr, 256, iniFile);
    str.ReleaseBuffer();
    ...
    ptr = str.GetBuffer(255);
    GetPrivateProfileString(section, _T("recordingButton"), _T("0"), ptr, 256, iniFileRec);
    str.ReleaseBuffer();
    ...
    GetPrivateProfileString(section, _T("defaultAction"), _T("call"), ptr, 256, iniFile);
    ...
    ptr = str.GetBuffer(255);
    GetPrivateProfileString(section, _T("callWaiting"), _T("0"), ptr, 256, iniFile);
    str.ReleaseBuffer();
