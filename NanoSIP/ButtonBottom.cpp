...
CButtonBottom::CButtonBottom()
{
	...
	m_bGrayDisabled = FALSE;

	m_clrButton = Theme::Control;
	m_clrButtonHover = Theme::ControlHover;
	m_clrButtonPushed = Theme::Selection;
	m_clrButtonText = Theme::Text;
...
{
	if (!IsWindowEnabled()) {
		m_clrFace = Theme::Window;
		m_clrRegular = Theme::TextDisabled;
	}
	else if (m_bCheckButton && m_bChecked) {
